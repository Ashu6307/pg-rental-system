...
const roomValidationSchema = Joi.object({
  ...
  media: Joi.object({
    ...
    areaImages: Joi.object({
      kitchen: Joi.array().items(Joi.string().uri()).max(10).default([]),
      bedroom: Joi.array().items(Joi.string().uri()).max(10).default([]),
      bathroom: Joi.array().items(Joi.string().uri()).max(10).default([]),
      livingRoom: Joi.array().items(Joi.string().uri()).max(10).default([]),
      balcony: Joi.array().items(Joi.string().uri()).max(10).default([]),
      parking: Joi.array().items(Joi.string().uri()).max(10).default([]),
      entrance: Joi.array().items(Joi.string().uri()).max(10).default([]),
