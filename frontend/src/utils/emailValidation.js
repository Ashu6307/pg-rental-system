...
export const EMAIL_VALIDATION_RULES = {
  ...
  examples: {
    valid: ['user@example.com', 'test.email@domain.co.in', 'user+tag@site.org'],
    invalid: ['user@', '@domain.com', 'user..name@domain.com', 'user@domain', 'USER@DOMAIN.COM (converted to lowercase)']
  }
};
